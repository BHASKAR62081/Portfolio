...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Supabase returns data in 'data' property
  ...
  useEffect(() => {
    // Try taking it from local storage first for faster loading.
    ...
    fetchData(); // Keep calling fetchData to sync the latest data.
  }, [fetchData]);
  ...
  // The rest of the components (return statement) are unchanged.
  return (
    <div
