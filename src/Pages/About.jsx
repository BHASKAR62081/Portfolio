...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    //this will show fresher according to the calculation
    if (experience === 0) {
      experience = "Fresher";
    }
    return {
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I’m a passionate and curious developer with a strong interest in
              building real-world web applications. Currently pursuing my degree
              in Computer Science, I enjoy exploring full-stack development,
              AI-powered tools, and innovative tech solutions. I love solving
              problems, collaborating on impactful projects, and continuously
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Technology is my language, learning is my journey, and impact
                is my destination."
              </blockquote>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/drive/folders/1qZ9ZaMMRN0O9BO1sH9h7UjLMOtyu3qPv"
